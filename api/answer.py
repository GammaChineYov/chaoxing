...
from tiku_ai.tiku_openAICompatibleAdapter import TikuOpenAICompatibleAdapter
class TikuOpenAICompatible(TikuOpenAICompatibleAdapter):
    pass

from tiku_scraper.tiku_scraper_adapter import TikuScraperAdapter
class TikuScraper(TikuScraperAdapter):
    # pure scraper data to direct use, very not suggest
    pass